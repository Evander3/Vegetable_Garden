...
<ul class="list-group">
  ...
  <li class="list-group-item active">Créer une page de <a href="params.php" style="color:yellow;">paramètrage</a></li>
  <li class="list-group-item active">Faire en sorte que le menu de navigation ne soit codé qu'une fois DRY</li>
  <li class="list-group-item active">Stocker en session les informations de paramètrages</li>
